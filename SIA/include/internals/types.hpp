...
namespace sia
{
    ...
    template <size_t Size>
    consteval auto _get_unsigned_byte_() noexcept
    {  
    ...
    template <size_t Size>
    consteval auto _get_signed_byte_() noexcept
    {  
    ...
    template <size_t Size>
    using unsigned_byte_t = decltype(_get_unsigned_byte_<Size>());
    template <size_t Size>
    using signed_byte_t = decltype(_get_signed_byte_<Size>());
